...
- Migrations `20260707000000_spotify_profiles.sql` through `20260708000004_listening_stats.sql` (the first 6) are applied to the live Supabase database — confirmed by Tim 2026-07-08. Two more were added in the 2026-07-08 dashboard redesign: `20260709000000_ms_played.sql` (**applied** — Tim pasted it) and `20260709000001_artist_rankings_by_name.sql` (**pending paste as of this note**). Keep pasting new ones into the Supabase Dashboard SQL editor, in filename order, until the CLI is linked (see `db push` note above).
