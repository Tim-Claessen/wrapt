...
- Migrations `20260707000000_spotify_profiles.sql` through `20260708000004_listening_stats.sql` (the first 6) are applied to the live Supabase database — confirmed by Tim 2026-07-08. Three more were added in the 2026-07-08/09 dashboard redesign: `20260709000000_ms_played.sql` (**applied** — Tim pasted it), `20260709000001_artist_rankings_by_name.sql` and `20260709000002_leaderboard_minutes_and_drill.sql` (both **pending paste as of this note**; 000002 DROP+CREATEs the leaderboard functions to add `total_ms` per-row minutes + a `p_artist` filter for the artist drill-down, and re-includes 000001's name-based artist ranking so it supersedes it). Keep pasting new ones into the Supabase Dashboard SQL editor, in filename order, until the CLI is linked (see `db push` note above).
